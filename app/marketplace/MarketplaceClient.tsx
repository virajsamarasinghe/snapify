...
export default function MarketplaceClient({
  ...
  const [whatsappNumber, setWhatsappNumber] = useState("94777901129");
      ...
      >
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          <h1 className="hero-text text-4xl lg:text-7xl font-bold text-white mb-6">
            <span className="inline-block bg-white text-black px-6 py-2">
              ART
            </span>
            <span className="inline-block ml-4">MARKETPLACE</span>
          </h1>
          <p className="hero-text text-white/80 text-lg max-w-2xl mx-auto">
            Discover and acquire unique pieces from our curated collection. Each
            artwork tells a story, waiting to become part of yours.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-8 lg:p-12 overflow-y-auto max-h-[80vh] lg:max-h-auto">
                ...
                <p className="text-white/40 text-xs mt-4 text-center">
                  Click the button above to connect directly with the artist via
                  WhatsApp for purchase inquiries
                </p>
              </div>
            </div>
          </div>
